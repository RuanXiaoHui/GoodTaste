...
public class SQLiteConstant {
    ...
    public static final String COLUMN_ARRIVAL_TIME = "arrivalTime"; // 到达时间
    public static final String COLUMN_ORDER_REMARKS = "remarks"; // 订单备注
    ...
    public static final String[] TABLE_ORDER_COLUMNS = new String[]{COLUMN_ORDER_ID, COLUMN_SHOP_NAME
            ...
            COLUMN_ARRIVAL_TIME + " varchar(50),", COLUMN_ORDER_REMARKS + " varchar(100),",
