    ...
    public static List<ShopBean> GetShop(){
        ...
        for (int i = 1; i <12 ; i++) {
            ...
            for (int j = 1; j <7 ; j++) {
                ...
                foods.add(new FoodBean(j+"00"+(i+1),""+j,"好味道姜汤"+j,R.mipmap.ic_launcher,33,4,"18",432,0));
                foods.add(new FoodBean(j+"00"+(i+2),""+j,"小鸡炖蘑菇"+j,R.mipmap.ic_launcher,33,4,"18",43,0));
                foods.add(new FoodBean(j+"00"+(i+3),""+j,"芥末小鸡"+j,R.mipmap.ic_launcher,33,4,"18",32,0));
                foods.add(new FoodBean(j+"00"+(i+4),""+j,"鲫鱼炖汤"+j,R.mipmap.ic_launcher,33,4,"18",22,0));
                foods.add(new FoodBean(j+"00"+(i+5),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",12,0));
                foods.add(new FoodBean(j+"00"+(i+6),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",212,0));
                foods.add(new FoodBean(j+"00"+(i+7),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",412,0));
                foods.add(new FoodBean(j+"00"+(i+8),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",43,0));
                foods.add(new FoodBean(j+"00"+(i+9),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",6,0));
                foods.add(new FoodBean(j+"00"+(i+10),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",98,0));
                foods.add(new FoodBean(j+"00"+(i+11),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",48,0));
                foods.add(new FoodBean(j+"00"+(i+12),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",40,0));
                foods.add(new FoodBean(j+"00"+(i+13),""+j,"老母鸡煲汤"+j,R.mipmap.ic_launcher,33,4,"18",41,0));
